...
opcode_entry opcode_table [512] = {
  ...
  /* 0x38 */	EMPTY, EMPTY, EMPTY, IDEX(E2G,cmp), // 0x3b cmp
  ...
  /* 0x68 */	IDEXW(push_SI, push, 1), EMPTY, EMPTY, EMPTY, // 0x6a push
  ...
  /* 0x84 */	EMPTY, IDEX(E2G, test), EMPTY, EMPTY, // 0x85 test
  ...
  /* 0x94 */	IDEX(E,setcc), EMPTY, EMPTY, EMPTY, // 0x0f94 SETcc(E/Z)
  /* 0x98 */	EMPTY, EMPTY, EMPTY, EMPTY,
  /* 0x9c */	EMPTY, EMPTY, EMPTY, EMPTY,
