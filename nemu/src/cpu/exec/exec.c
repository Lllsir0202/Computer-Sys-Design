...
make_group(gp4,
  ...
  // 0x02 call r/m16
make_group(gp5,
    EMPTY, EMPTY, IDEX(I, call_rm), EMPTY,
...
opcode_entry opcode_table [512] = {
  /* 0x00 */	EMPTY, IDEX(E2G,add), EMPTY, IDEX(E2G,add), // 0x01
  ...
  /* 0x38 */	EMPTY, IDEX(E2G,cmp), EMPTY, IDEX(E2G,cmp), // 0x39 cmp 0x3b cmp
  ...
  /* 0x74 */	IDEXW(J,jcc,1), IDEXW(J,jcc,1), EMPTY, IDEXW(J,jcc,1), // 0x74 jz/je 0x75 jnz/jne 0x77 ja/jnbe
  /* 0x78 */	EMPTY, EMPTY, EMPTY, EMPTY, 
  /* 0x7c */	EMPTY, IDEXW(J,jcc,1), IDEXW(J,jcc,1), IDEXW(J,jcc,1), // 0x7d jnl/jge 0x7e jle 0x7f jg/jnle
  /* 0x80 */	IDEXW(I2E, gp1, 1), IDEX(I2E, gp1), EMPTY, IDEX(SI2E, gp1), // 0x83 SUB r/m32,imm8 or SUB r/m16, imm8
  /* 0x84 */	IDEXW(E2G,test,1), IDEX(E2G, test), EMPTY, EMPTY, // 0x84 test 0x85 test
  ...
  /* 0xe8 */	IDEXW(J,call,4), IDEX(J, jmp), EMPTY, IDEXW(J,jmp,1),   // 0xe8 CALL rel32 0xe9 jmp 0xeb 
